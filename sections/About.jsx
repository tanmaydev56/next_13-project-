  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        this metaverse world, because this is really the <span className='font-extrabold text-white'>  madness of the metaverse</span> of today, using only <span className='font-extrabold text-white'> VR</span> devices you can easily <span className='font-extrabold text-white'>explore</span> the
      ...
      src="/arrow-down.svg" alt="arr-down" 
      />
    </motion.div>
  </section>
);
